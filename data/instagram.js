...
async function igUserInfo(username) {
    var payload;
    try {
...
async function igReelDownload(url) {
    var data;
    try {
...
async function igStoryDownload(username_query) {
    var data = await axios({
...
module.exports = { igPostDownload, igReelDownload, igUserInfo, igStoryDownload };
